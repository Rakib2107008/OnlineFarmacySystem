                ...
                <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
                            ...
                            <option value="Medicines" {{ old('category', $product->category) == 'Medicines' ? 'selected' : '' }}>Medicines</option>
                            <option value="Diabetic Care" {{ old('category', $product->category) == 'Diabetic Care' ? 'selected' : '' }}>Diabetic Care</option>
                            <option value="Personal Care" {{ old('category', $product->category) == 'Personal Care' ? 'selected' : '' }}>Personal Care</option>
                            <option value="Sexual Wellbeing" {{ old('category', $product->category) == 'Sexual Wellbeing' ? 'selected' : '' }}>Sexual Wellbeing</option>
                            <option value="Vitamin & Supplements" {{ old('category', $product->category) == 'Vitamin & Supplements' ? 'selected' : '' }}>Vitamin & Supplements</option>
                            <option value="Women Care" {{ old('category', $product->category) == 'Women Care' ? 'selected' : '' }}>Women Care</option>
                            <option value="Baby & Mom" {{ old('category', $product->category) == 'Baby & Mom' ? 'selected' : '' }}>Baby & Mom</option>
                        </select>
                        @error('category')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror

...
<section class="products-section">
  <div class="container" id="productContainer">
    <h2 class="section-title">Baby & Mom</h2>
...
<script>
(function() {
  // Re-hydrate floating cart UI immediately (same pattern as other fixed pages)
  ...
  setTimeout(() => {
    ...
    } catch(e) { console.warn('Cart hydrate fallback failed on babyMom page:', e); }
  }, 0);

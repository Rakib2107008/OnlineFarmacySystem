...
// When using paginate(), Laravel returns an object with 'data' property
    ...
    colDiv.innerHTML = `
        <div class="product-card">
            ...
            <img src="${imageUrl}" 
                 alt="${product.name}" 
                 class="product-img"
                 onerror="this.src='https://via.placeholder.com/300x200/e0e0e0/666666?text=Medicine'">
    ...
    productRow.innerHTML = `
        <div class="col-12">
            <div class="empty-state">
                ...
                <h5>No medicines available at the moment</h5>

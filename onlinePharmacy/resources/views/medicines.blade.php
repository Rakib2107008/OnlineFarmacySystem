...
document.addEventListener('DOMContentLoaded', function () {
  // Ensure floating cart updates correctly when navigating
  window.dispatchEvent(new Event('floating-cart-updated'));

  // Laravel passes the paginated medicines
  ...
  document.addEventListener('click', (event) => {
    ...
    if (typeof window.addToFloatingCart === 'function') {
      Promise.resolve(window.addToFloatingCart(productId, productName, unitPrice, 'medicines'))
        ...
        .catch((error) => console.warn('Unable to add product to cart', error));
    } else {
      console.warn('Floating cart function not available on medicines page.');
    }
  });
